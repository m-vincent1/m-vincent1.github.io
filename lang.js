...
const translations = {
  fr: {
    ...
    cert_cisco_title: "Cybersécurité",
    ...
    cert_nse2_title: "Technical Cybersecurity 3.0",
    cert_nse2_issuer: "Fortinet Training Institute",
    cert_nse1_title: "Threat Landscape 3.0",
    cert_nse1_issuer: "Fortinet Training Institute",
    cert_darkweb_title: "Dark Web, Anonymity, and Cryptocurrency",
    ...
    contact_subtitle:
      "Disponible pour un stage de 6 mois (janvier-juin 2027). Présent à Angers, Chambéry et Lyon.",
  ...
  en: {
    ...
    cert_fcf_title: "Fortinet Certified Fundamentals in Cybersecurity",
    cert_fcf_issuer: "Fortinet Training Institute",
    cert_cisco_title: "Cybersecurity",
    cert_cisco_issuer: "Cisco Networking Academy",
    ...
    contact_subtitle: "Available for a 6-month internship (January-June 2027) in Angers, Chambéry and Lyon.",
    contact_info_note: "I reply quickly by email or phone.",
    contact_info_email_title: "Email",
    contact_info_phone_title: "Phone",
    contact_info_address_title: "Locations",
    contact_info_linkedin_title: "LinkedIn",
    contact_email_label: "mathisvincent446@gmail.com",
    contact_phone_label: "+33 6 77 07 42 51",
    contact_address_label: "Angers &middot; Chambéry &middot; Lyon",
